...
def prepare_data_for_model(data, frame_idx=0):
    ...
    return node_features, pos_irreps
...
# STEP 3: Run Output
input_irreps_obj = sample_graph.irreps
print("input_irreps_obj: ", input_irreps_obj )
input_irreps_pos = sample_pos.irreps
print("input_irreps_pos: ", input_irreps_pos )
