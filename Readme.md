...
A Tensor Cloud is set, whose elements are tuples. Each tuple is a tensor V_i associated to a 3D position P_i, in essence {V_i, P_i}, where the degree l of the tensors is 0 < l < l_max.
